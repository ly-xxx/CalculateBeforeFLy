...
class _StatisPageState extends State<StatisPage> {
  ...
  Widget getPie() {
    List<Piesales> dataPie = [
      Piesales(1, getMonth(now.month.toString(), 1),Provider.of<ThemeProvider>(context).pieColor[0],"学习"),
      Piesales(2, getMonth(now.month.toString(), 2), Provider.of<ThemeProvider>(context).pieColor[1],"娱乐"),
      Piesales(3, getMonth(now.month.toString(), 3), Provider.of<ThemeProvider>(context).pieColor[2],"交通"),
      Piesales(4, getMonth(now.month.toString(), 4), Provider.of<ThemeProvider>(context).pieColor[3],"工资"),
    ];
